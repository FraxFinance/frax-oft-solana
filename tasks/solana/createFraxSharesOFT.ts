...
task('lz:oft:solana:create:fxs', 'Mints new SPL Token and creates new OFT Config account')
    ...
    .setAction(async (taskArgs: Args) => {
        ...
        const createTokenTx = await createAndMint(umi, {
            ...
            uri: 'https://arweave.net/RnwGvwWWPuSBkyj4tz3ws4FrOUc-mMmqJD4xVYzgPuQ', // URI for token metadata
        ...
        fs.writeFileSync(`${outputDir}/FXSOFT.json`, JSON.stringify(accountsJson, null, 2))
        console.log(`Accounts have been saved to ${outputDir}/FXSOFT.json`)
    })
